...
export default function ImportarHealthScore({ onConcluido }: { onConcluido?: (centrais: number, mensais: number) => void }) {
  ...
  async function handleConfirmar() {
    ...
    setConcluido(true);
    setProgresso("");
    if (onConcluido) onConcluido(centraisRows.length, mensaisRows.length);
  }
        ...
        {analisado && !concluido && (
          <div className="space-y-5">
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-white dark:bg-slate-50 rounded-xl border border-slate-200/80 p-4">
            ...
            <div className="bg-white dark:bg-slate-50 rounded-2xl border border-slate-200/80 shadow-sm overflow-hidden">
              ...
              <div className="max-h-96 overflow-y-auto">
                <table className="w-full text-sm">
                  <thead className="bg-slate-50 dark:bg-slate-100 sticky top-0">
        ...
        {concluido && (
          <div className="bg-white dark:bg-slate-50 rounded-2xl border border-slate-200/80 shadow-sm p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">
              ...
              Agora clique em “Recalcular Health Score” abaixo para gerar as notas.
            </p>
            <button onClick={cancelar} className="text-sm px-4 py-2 rounded-lg border border-slate-300 text-gray-600 hover:bg-slate-100 bg-white">
