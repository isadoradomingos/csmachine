        ...
        <>
          ...
          <div className="fixed top-0 left-0 h-full w-72 max-w-[80vw] bg-white z-50 shadow-xl flex flex-col animate-[slideIn_0.2s_ease-out]">
            ...
            <div className="flex-1 px-3 py-4 space-y-1">
              ...
              {/* Placeholder do tema (projeto futuro) */}
              <div className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-400">
                <svg className="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="5" />
                  <line x1="12" y1="1" x2="12" y2="3" /><line x1="12" y1="21" x2="12" y2="23" />
                  <line x1="4.22" y1="4.22" x2="5.64" y2="5.64" /><line x1="18.36" y1="18.36" x2="19.78" y2="19.78" />
                </svg>
                Tema claro/escuro <span className="text-xs">(em breve)</span>
              </div>
            </div>
