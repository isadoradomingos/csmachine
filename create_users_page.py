...
# 1. Criar API route para convidar usuários
os.makedirs("src/app/api/invite", exist_ok=True)
api_content = '''import { createClient } from "@supabase/supabase-js";
...
with open("src/app/api/invite/route.ts", "w") as f:
    f.write(api_content)
print("API route criada!")

# 2. Criar API route para deletar usuário
os.makedirs("src/app/api/delete-user", exist_ok=True)
delete_content = '''import { createClient } from "@supabase/supabase-js";
import { NextResponse } from "next/server";
...
with open("src/app/api/delete-user/route.ts", "w") as f:
    f.write(delete_content)
print("API de delete criada!")

# 3. Criar página de usuários no admin
os.makedirs("src/app/admin/usuarios", exist_ok=True)
...
with open("src/app/admin/usuarios/page.tsx", "w") as f:
    f.write(page_content)
print("Página de usuários criada!")
